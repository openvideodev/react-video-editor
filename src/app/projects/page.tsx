...
import { Plus, Video, Search, Trash2, MoreHorizontal, X, PlusIcon, ChevronRight, Home } from "lucide-react";
                    ...
                    <div className="flex flex-col items-center justify-center p-8 text-center text-muted-foreground mt-8 space-y-2">
                        <div className="py-2 text-stone-600">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24">
                                <path fill="currentColor" fillRule="evenodd" d="M2.07 5.258C2 5.626 2 6.068 2 6.95v2.3h19.953c-.072-1.049-.256-1.737-.723-2.256a3 3 0 0 0-.224-.225C20.151 6 18.834 6 16.202 6h-.374c-1.153 0-1.73 0-2.268-.153a4 4 0 0 1-.848-.352C12.224 5.224 11.816 4.815 11 4l-.55-.55c-.274-.274-.41-.41-.554-.53a4 4 0 0 0-2.18-.903C7.53 2 7.336 2 6.95 2c-.883 0-1.324 0-1.692.07A4 4 0 0 0 2.07 5.257m19.928 5.492H2V14c0 3.771 0 5.657 1.172 6.828S6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14v-2.202z" clipRule="evenodd" />
                            </svg>
                        </div>
                        {searchQuery ? (
                            <>
                            ...
                            <>
                                ...
                                <Button onClick={handleCreateProject} variant="outline" className="mt-1 px-5 rounded-full gap-1.5">
