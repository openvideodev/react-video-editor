  ...
  const add_text = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        ...
        from: z.number().default(0).describe("Start time in seconds (default 0)"),
  ...
  const add_image = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        prompt: z.string().describe("Detailed description of the image to generate or add"),
        url: z.string().optional().describe("URL of the image if available"),
        targetId: z.string().optional().describe("The unique ID for this new asset"),
        from: z.number().default(0).describe("Start time in seconds (default 0)"),
        to: z.number().default(5).describe("End time in seconds (default 0)"),
      }),
      outputSchema: z.object({
  ...
  const update_clip = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        ...
        fontFamily: z.string().optional().describe("Font family for text clips"),
  ...
  const duplicate_clip = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        targetId: z.string().optional().describe("The ID of the clip to duplicate"),
      }),
      outputSchema: z.object({
        message: z.string(),
      }),
    ...
    async ({ targetId }) => {
      return {
        message: targetId ? `Clip ${targetId} duplicated` : "Selected clips duplicated",
      };
    },
  );
  ...
  const trim_clip = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        ...
        trimFrom: z
          .number()
          .describe("The new start time in seconds relative to the clip's source"),
      }),
      outputSchema: z.object({
        message: z.string(),
      }),
  ...
  const search_and_add_media = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        ...
        type: z.enum(["video", "image"]).default("video").describe("Type of media"),
  ...
  const generate_captions = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        clipIds: z.array(z.string()).optional().describe("Specific clips to transcribe"),
      }),
      outputSchema: z.object({
        message: z.string(),
      }),
